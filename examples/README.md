...
| [`iteration.cpp`](iteration.cpp) | brackets and iteration: `doc["tag"]`/`doc[1]` lookups with `operator[]`, children and attributes as uniform views with range-for and `<algorithm>` |
